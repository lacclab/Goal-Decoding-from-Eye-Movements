...
class PostFusionModel(BaseMultiModalRoberta):
    def __init__(
        ...
        self.add_question = model_args.add_question
    ...
    def split_context_embeds(
        ...
        if self.add_answers and self.add_question:
            assert (
                split_sizes.size == 5
        ...
        elif not self.add_answers and self.add_question:
            assert (
                split_sizes.size == 4
        ...
        elif self.add_answers and not self.add_question:
