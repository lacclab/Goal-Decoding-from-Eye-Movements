...
NUM_FOLDS = 10
NUM_ADDITIONAL_FIXATIONS_FEATURES = 4
...
class ItemLevelFeaturesModes(StrEnum):
    ...
    DAVID_EYES_ONLY = "DavEOnly(FSE)"
    LENNA = "Lenna"
    DIANE = "Diane"
    DAVID_n_LENNA_n_DIANE = "David_n_Lenna_n_Diane"
    TOTAL_READING_TIME = "TotalReadingTime"
    AVERAGE_DWELL_TIME = "AvgDWELL"  # total reading time / total number of fixations
    READING_SPEED = (
        "ReadingSpeed"  # total words / total reading time * 1000 (words-per-sec)
    )
...
class ModelNames(StrEnum):
    ...
    PLMAS_MODEL = "PLMAS_MODEL"
    PLMASF_MODEL = "PLMASF_MODEL"
    FIXATION_SEQUENCE_ENCODER_MODEL = "FIXATION_SEQUENCE_ENCODER_MODEL"
    HALLER_W_FF_MODEL = "HALLER_W_FF_MODEL"
