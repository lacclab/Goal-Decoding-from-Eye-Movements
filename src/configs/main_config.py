...
from src.models.plm_as_model import PLMASModel
from src.models.plm_as_f_model import PLMASFModel
...
from src.models.fixation_sequence_encoder_model import FixationSeqEncoderModel
from src.models.haller_with_ff_model import HallerWithFFModel
...
class ModelMapping(Enum):
    ...
    FIXATION_SEQUENCE_ENCODER_MODEL = FixationSeqEncoderModel
    HALLER_W_FF_MODEL = HallerWithFFModel
