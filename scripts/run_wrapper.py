...
ModelOptions = Literal[
    ...
    "BEyeLSTMCondPredArgs",  # Condition Prediction
    "FixSeqEncCondPredArgs",  # Condition Prediction
    "EyettentionCondPredArgs",  # Condition Prediction
    "RoberteyeConcatCondPredWordsArgs",  # Condition Prediction
    "RoberteyeConcatCondPredFixationsArgs",  # Condition Prediction
    "RoberteyeConcatCondPredFixationsFreezedArgs",  # Condition Prediction
    "MAGCondPredArgs",  # Condition Prediction
    "PLMASCondPredArgs",  # Condition Prediction
    "PLMASfCondPredArgs",  # Condition Prediction
    "HallerWFFCondPredArgs",  # Condition Prediction
    "MAGBase",
    "MAGFreeze",
    "MAGEyes",
    "MAGWords",
...
DataPathOptions = Literal["april14", "may05", "august06"]

# ML
MLTrainerOptions = Literal["CfirMLQCond", "CfirMLQPred", "CfirJunk", "CfirMLVanila"]
MLModelOptionsIsCorrect = Literal[
    # Is Correct Prediction
    "DummyClassifierIsCorrectPredMLArgs",
    "KNearestNeighborsIsCorrectPredEMNLPMLArgs",
    "LogisticRegressionIsCorrectPredEMNLPMLArgs",
    "SupportVectorMachineIsCorrectPredEMNLPMLArgs",
    # --- Is Correct Prediction with Diane features
    "LogisticRegressionIsCorrectPredDianeEMNLPMLArgs",
    # Condition Prediction
    "LogisticRegressionCondPredAvgDwellTimeMLArgs",
    "LogisticRegressionCondPredReadingSpdMLArgs",
]
MLModelOptionsConditionPred = Literal[
    "DummyClassifierCondPredMLArgs", "LogisticRegressionCondPredDianeMLArgs"
]
MLModelOptions = MLModelOptionsIsCorrect | MLModelOptionsConditionPred
